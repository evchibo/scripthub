...
if(isset($_GET['url']) && $_GET['url'] != 'admin/') {
	...
	//	$paging = '<div class="pagination"><div class="page_numbers"><span class="page-first">'.$langArray['page'].'</span>';
		...
		if ($currentPage > 1)
			$paging .= '<a href="' . $frontUrl . '' . ($currentPage - 1) . '' . $backUrl . '" title="Previous page" class="previous_page">Prev</a>';
		...
		if ($currentPage < $pages)
			$paging .= '<a href="' . $frontUrl . '' . ($currentPage + 1) . '' . $backUrl . '"  title="Next page" class="next_page">Next</a>';
